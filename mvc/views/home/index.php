...
<head>
    ...
    <script type="module" src="{{base}}/assets/js/select-options.js" defer></script>
    <script src="{{base}}/assets/js/scrolling.js" defer></script>
...
<body>
    <nav>
        <div class="logo">
            <div class="logo-img"><img src="{{base}}/assets/img/nav/logo.jpg" alt="logo_img"></div>
            ...
            <div class="structure">
                <div class="reservation-boxes-container">             
                    <div class="container__form-deals">
                        <div class="form-box">
                            <form class="form-reservation" action="{{base}}/process_reservation" method="POST">
                        ...
                        <div class="deals-box">
                            <h1 class="deals-title">OBTENEZ 15% DE RABAIS SUR VOTRE LOCATION</h1>
                            <div class="deals-img">
                                <img src="{{base}}/assets/img/gallery/mercedes.jpg" alt="mercedes-img">
                            </div>
                        </div>
                    </div>
                </div>
